/*
  ...
  - Added the required column `teamName` to the `team_achievement` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_team_achievement" ("achievement", "createdAt", "id", "matchId", "season", "teamId") SELECT "achievement", "createdAt", "id", "matchId", "season", "teamId" FROM "team_achievement";
